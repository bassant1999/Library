...
class Model 
{
	...
	public function where($data, $data_not = [], $IN = false, $col = "")
	{
	...
	public function insert($data)
	{
		...
		// print_r("id: ", $this->query("SELECT SCOPE_IDENTITY()"));
		$t = $this->query($query, $data, true);
		return 	$t;
	}
	...
	public function remove($data, $data_not = [])
	{
		$keys = array_keys($data);
		$keys_not = array_keys($data_not);
